-- ============================================
-- PERSONAL NOTES FORM DATABASE SETUP
...
CREATE TABLE IF NOT EXISTS personal_notes_forms (
  ...
  -- J. References (renamed to avoid conflict with SQL keyword)
  reference_history JSONB,
...
DO $$
BEGIN
  RAISE NOTICE '✅ Personal Notes Form tables and policies created successfully!';
  RAISE NOTICE '📋 Table: personal_notes_forms';
  RAISE NOTICE '🗂️  Storage bucket: personal-notes-forms';
  RAISE NOTICE '🔒 RLS policies: Active';
  RAISE NOTICE '';
  RAISE NOTICE 'Next steps:';
  RAISE NOTICE '1. Visit /personal-notes-form to test the form';
  RAISE NOTICE '2. Check Admin Dashboard → Personal Notes tab';
  RAISE NOTICE '3. Share form link with employees';
END $$;
